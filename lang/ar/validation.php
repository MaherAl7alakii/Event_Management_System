...
return [
    ...
    'attributes' => [
        ...
        'max_guests'          => 'الحد الأقصى للمدعوين',
        'images'              => 'الصور',
        'images.*.url'        => 'رابط الصورة',
        'images.*.is_primary' => 'الصورة الأساسية',
        'ar.title'            => 'العنوان باللغة العربية',
        'ar.description'      => 'الوصف باللغة العربية',
        'ar.address'          => 'العنوان التفصيلي باللغة العربية',
        'en.title'            => 'العنوان باللغة الإنجليزية',
        'en.description'      => 'الوصف باللغة الإنجليزية',
        'en.address'          => 'العنوان التفصيلي باللغة الإنجليزية',
        'features'            => 'الميزات',
